...
trait ApiResponder
{
    ...
    // public static function successResponse(mixed $data, $message, int $statusCode = Response::HTTP_OK): JsonResponse
    // {
    //     if(!$message) {
    ...
    // public static function okResponse(mixed $data, $message = ''):JsonResponse
    // {
